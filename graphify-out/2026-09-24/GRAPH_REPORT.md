...
## Corpus Check
- 251 files · ~162,123 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 78 file(s) not represented in the graph (top: .st 63, (none) 13, .toml 1)

## Summary
- 4045 nodes · 10682 edges · 165 communities (148 shown, 17 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1488 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2784b78d`
...
Cohesion: 0.06
Nodes (45): FailedProbeKeepsCurrentSession, ImageSave, ImageSaveLoad, KernelMethodsStayNative, LoadSizesOldFromHeader, NurseryGcAfterLoad, OnePlusTwoMatches, RejectsBadMagicAndSecondLoad (+37 more)
...
### Community 7 - "Oop"
Cohesion: 0.11
Nodes (59): [High] printOn: が新しい printString を使わない, Oop, kCharTag, kImmTag, kLow3, kSmiTag, raw_, ao_Object_basicAt_() (+51 more)
...
Cohesion: 0.13
Nodes (16): int16_t, Op, size_t, string_view, uint16_t, uint8_t, Emitter, real_ (+8 more)
...
### Community 12 - "TEST"
Cohesion: 0.04
Nodes (51): ByteObjectPayloadIsNotScannedAsOops, CollectOldOnlyAfterThreshold, CompactionDuringScavengeDoesNotCorruptSlots, DeadOldSlotIsNotANurseryRoot, DestJumpPastPinDoesNotOverlap, DuplicateRootForwardedOnce, GcOld, GcRoots (+43 more)
...
Cohesion: 0.10
Nodes (27): AoSpan, end, message, start, [High] Workspace 束縛が 255 temp の上限に達すると eval が全滅, 07 Swift アプリ・ビルド・スクリプト, [Low] `AoSpan` の区間を捨てているので、エラー位置が分からない, [Low] C++ のデプロイメントターゲットがアプリの最小 OS と一致していない (+19 more)
...
### Community 20 - "Roots"
Cohesion: 0.06
Nodes (36): Root, slot, FrameBlock, capacity, slots, used, size_t, StackWalker (+28 more)
...
### Community 35 - "vector"
Cohesion: 0.12
Nodes (24): ao_abi, Chunk, compile, CompiledMethod, compiler, string, vector, context (+16 more)
...
Cohesion: 0.14
Nodes (36): [Medium] メソッド辞書の拡張に失敗するとメソッドを黙って捨て、`installMethod` は成功を返す, [High] チャンク経由でメソッドを再定義してもメソッドキャッシュを無効化しない, [High] vendor file-in のメソッドコンパイル失敗を成功として返し、17 メソッドが黙って欠落する, FileInError, error, file, method, string (+28 more)

### Community 39 - "TEST"
Cohesion: 0.07
Nodes (25): BlockWithArgs, Cascade, Codegen, CompileResult, error, image, ok, ParseResult (+17 more)

### Community 40 - "BrowserWindow"
Cohesion: 0.10
Nodes (22): BrowserWindow, .acceptsMethod, .errorText, .hasUnacceptedChanges, .paneAccessibilityLabels, .sourceText, .title, String (+14 more)
...
Cohesion: 0.19
Nodes (22): appendRaw(), appendRecord(), collectExtra(), collectImageSlot(), byte, size_t, string_view, uintptr_t (+14 more)
...
Cohesion: 0.07
Nodes (32): AbiSmoke, BootAndShutdownReturnZero, BootVersionShutdown, CleanupFailureReleasesItsReasonHandle, DefaultDoesNotUnderstandAborts, B2 `to:do:` bench, C ABI, P8–P9 Remaining Implementation Plan (+24 more)

### Community 50 - ".nil"
Cohesion: 0.19
Nodes (32): int64_t, Gc::clearWeakAfterOldMark(), ao_BlockContext_fork(), ao_MethodContext_method(), ao_MethodContext_receiver(), ao_MethodContext_sender(), ao_Process_priority_(), ao_Process_resume() (+24 more)
...
### Community 57 - "Parser"
Cohesion: 0.12
Nodes (19): uint32_t, SourceSpan, end, start, deque, Kind, string, string_view (+11 more)

### Community 58 - "unwinding"
Cohesion: 0.20
...
Cohesion: 0.08
Nodes (33): [Critical] スキャベンジ中に `collectOld` が走ると、移動前のヘッダ位置へ書き込む, [High] old 4MB 固定と promote-all のため、生存約 2.5MB で毎回無駄なフル GC を回して実質停止する, [High] old 枯渇でスキャベンジが失敗すると、転送済みオブジェクトがナーサリに残り、同一性が割れる, [High] ナーサリ半面（1MB）を超えるオブジェクトは一切割り当てられず、失敗も見えない, [Low] identity hash が 16 ビットで、SPEC のサイドテーブルがない, 指摘, B1 GC 安全性と old space の拡張（テーマ 1、01 全件、03/04 の Critical）, GC と Heap（Gc.cpp、Heap.cpp、新規 `runtime/src/VirtualRegion.{hpp,cpp}`） (+25 more)

### Community 66 - "ToolWindowTests"
Cohesion: 0.23
Nodes (7): NSMenu, NSMenuItem, NSTextView, NSView, String, T, ToolWindowTests

### Community 67 - "CompileError"
Cohesion: 0.08
Nodes (24): ActionsCarryTheirChunkSpan, BangInCharacterDoesNotSplit, BangSpaceBangEndsMethodButDoubleBangStaysLiteral, ChunkFileIn, ChunkLevelErrorsCarryTheChunkSpan, ChunksAfterSectionEndAreFlagged, ClassDefinitionAbortIsAnErrorAndIsCleared, ClassDefinitionShape (+16 more)

### Community 69 - ".init"
Cohesion: 0.13
Nodes (11): Any, Int, NSRect, NSSegmentedControl, NSTableView, NSTextField, NSTextView, NSView (+3 more)
...
Cohesion: 0.14
Nodes (27): cctype, acceptClassSource(), assignError(), boxBytes(), boxedOk(), boxLiteral(), boxMethodImage(), CarriedMethod (+19 more)
...
Cohesion: 0.10
Nodes (20): BrowserModel, .metaFlag, ListedClass, Bool, CChar, Int32, String, BrowserModelTests (+12 more)
...
### Community 86 - ".true_"
Cohesion: 0.21
Nodes (24): ao_Behavior_basicNew_(), ao_Behavior_compiledMethodAt_(), ao_Behavior_includesSelector_(), ao_Behavior_inheritsFrom_(), ao_Behavior_instSize(), ao_Behavior_isBytes(), ao_Behavior_isPointers(), ao_Behavior_isVariable() (+16 more)

### Community 87 - "TEST"
Cohesion: 0.05
Nodes (54): AcceptAbi, AcceptClassRefusesChunksAfterSectionEnd, AcceptClassRefusesClassAsItsOwnSuperclass, AcceptClassRefusesNonDefinitionWithoutApplying, AcceptClassRefusesStatementsAfterDefinition, AcceptClassStopsAtRefusedDefinitionKeepingEarlierChunks, AcceptClassTakesChunkDefinitionAndMethods, AcceptMethodRefusesNonBehaviorName (+46 more)
...
Cohesion: 0.09
Nodes (26): 01 オブジェクトメモリ・GC・ブートストラップ, GC 安全性（ネイティブ）の横断評価 — 03 からの照会への回答, [Medium] グローバル `Smalltalk` がクラス nil の 57 要素固定配列で、どのメッセージも通らない, テストの穴, 概要, 02 インタプリタ・送信・コンテキスト・プロセス, テストの穴, 概要 (+18 more)

### Community 95 - "Ao"
Cohesion: 0.29
Nodes (7): Ao, Build and test, Documentation, Layout, License, Requirements, Status

### Community 96 - "Claude レビュー指摘の修正計画（docs/claude-review）"
Cohesion: 0.12
...
### Community 97 - ".false_"
Cohesion: 0.28
Nodes (9): uint64_t, boolean(), ao_Magnitude_between_and_(), ao_Magnitude_greaterOrEqual(), ao_Magnitude_greaterThan(), ao_Magnitude_lessOrEqual(), CallContext, uint32_t (+1 more)
...
### Community 113 - "applyChunks"
Cohesion: 0.18
Nodes (14): [Critical] クラス定義でない文字列が AO_OK で黙って捨てられる, Global Constraints, P6b vendor file-in Implementation Plan, Self-review, Task 2: ピンと vendor ソース, Task 3: rebind と上書き禁止, Task 5: `ao filein` と評価, Task 6: フェーズ完了 (+6 more)
...
### Community 117 - ".changeSelection"
Cohesion: 0.18
Nodes (7): sendToKeyBrowser(), Bool, Int32, MainActor, Notification, NSWindow, Void

### Community 118 - "P7 .aoimage Implementation Plan"
Cohesion: 0.15
Nodes (13): Global Constraints, P7 .aoimage Implementation Plan, Task 2: 再結合に必要なヒープとレジストリの口, Task 3: save, Task 4: load と受け入れ評価, Task 5: CLI, Task 6: フェーズを閉じる, リスク (+5 more)
...
Cohesion: 0.05
Nodes (63): pthread, uint32_t, unique_ptr, RootedArray, data_, inline_, kInlineSlots, n_ (+55 more)
...
Cohesion: 0.12
Nodes (17): HeaderRoundTripAndRejects, HeapShapedBitsAreNotImmediates, ImmediateBitsRoundTrip, ImageFormat, decodeNonHeap, encodeNonHeap, kImageEndianLittle, kImageFillerBytes (+9 more)

### Community 128 - "仕様"
Cohesion: 0.25
Nodes (8): CLI, extra 節, globals 節, load, OOP エンコード, save, well-known 節, 仕様

### Community 129 - "B2 ブロックの意味論とインタプリタ（05 Critical、02 全件、00 のワークスペース High ×4）"
Cohesion: 0.25
Nodes (8): B2 ブロックの意味論とインタプリタ（05 Critical、02 全件、00 のワークスペース High ×4）, SPEC を先に直す, スタックガード、abort、死んだホーム, ネイティブ側（`Send.hpp/.cpp` に共通ヘルパーを置く）, リスク, ワークスペース変数（00 High ×3 と Medium を同時に解消する）, 共有 temp（`compiler/src/Codegen.cpp`）, 手順（各段を緑にしてから次へ進む）
...
Cohesion: 0.22
Nodes (11): BytecodeIsa, Op, uint8_t, operandBytes(), specialCount(), specialSelector(), TEST(), NewOpsAppendedAfterPrimitive (+3 more)

### Community 141 - ".heapPointer"
Cohesion: 0.29
Nodes (6): clearWeakAfterOldMark, Gc::collectOld(), Gc::copy(), Heap::checkNotPoisoned(), Heap::inNursery(), Heap::inOld()

### Community 142 - "P4-05 Dictionary / Set / OrderedCollection"
Cohesion: 0.40
...
### Community 148 - "指摘"
Cohesion: 0.11
Nodes (21): CompileEnv, instVarNames, knownGlobals, undeclaredAreBindings, [Critical] Kernel クラスのサブクラスで、インスタンス変数の添字が親の物理スロットと重なる, [High] 2^63 以上の整数リテラルが黙って 0 になる, [High] クラス変数を読み書きできない, [Low] カスケードの扱いが不完全 (+13 more)
...
### Community 160 - "Gc"
Cohesion: 0.07
Nodes (39): algorithm, BlockContextKeepsHomeAndCopied, ContextGc, cstdlib, MethodContextSurvivesNurseryCollection, NativeBlockThunkStillValues, optional, Gc (+31 more)

### Community 163 - ".isHeap"
Cohesion: 0.08
Nodes (52): [Low] `Roots` が同じスロットの二重登録を許し、`collectOld` の更新は冪等でない, run, InlineCache, cachedClass, cachedMethod, uint8_t, applyMethod(), refreshStackLimit() (+44 more)

### Community 164 - "ClassDef"
Cohesion: 0.25
Nodes (8): Task 1: changes 切り出し, ClassDef, bytes, indexable, instSize, name, WellKnown, int64_t
...
### Community 175 - "Bootstrap"
Cohesion: 0.18
Nodes (14): Bootstrap, chrono, Lookup, MethodDictionary, answerOne(), answerTwo(), CallContext, uint32_t (+6 more)
...
## Knowledge Gaps
- **806 isolated node(s):** `.metaFlag`, `.hasUnacceptedChanges`, `.title`, `.sourceText`, `.errorText` (+801 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 1676 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **17 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Oop` connect `Oop` to `WellKnown`, `.fromSmallInteger`, `LargeInteger.cpp`, `image_save_load_test.cpp`, `Stream.cpp`, `Float.cpp`, `Heap.cpp`, `TEST`, `TEST`, `Heap`, `Roots`, `Geometry.cpp`, `TEST`, `Boot`, `TEST`, `TEST`, `Session.cpp`, `uint32_t`, `NativeMethod.cpp`, `TEST`, `TEST`, `vector`, `CallContext`, `ImageSave.cpp`, `CallContext`, `.nil`, `TEST`, `BlockContext.cpp`, `TEST_F`, `TEST`, `unwinding`, `String.cpp`, `putNative`, `allocateRetry`, `DiskHeader`, `abortingSubclass`, `Compile.cpp`, `WellKnown.cpp`, `TEST`, `Boolean.cpp`, `cstdint`, `TEST`, `.true_`, `TEST`, `TEST`, `TEST`, `Ao`, `.false_`, `Bootstrap.cpp`, `CompiledMethodNatives.cpp`, `native_method_test.cpp`, `applyChunks`, `ImageLoad.cpp`, `send2`, `SmallInteger.cpp`, `GarbageFirstBoot`, `natives`, `ObjectHeader`, `Interpreter.cpp`, `ImageFormat`, `Format.hpp`, `NameCollect`, `Ao`, `TEST`, `Array.cpp`, `Globals.cpp`, `.heapPointer`, `Roots.cpp`, `指摘`, `intern`, `指摘`, `ClassMethodCache`, `imageRegistryStubA`, `Gc`, `.isHeap`, `ClassDef`, `Bootstrap`, `abortingNew`?**
  _High betweenness centrality (0.364) - this node is a cross-community bridge._
- **Why does `vector` connect `vector` to `Codegen.cpp`, `LargeInteger.cpp`, `NameCollect`, `image_save_load_test.cpp`, `VendorExtract.cpp`, `Oop`, `Emitter`, `Bytecode.hpp`, `Literal`, `ao_main.cpp`, `ChunkAction`, `指摘`, `Roots`, `Session.cpp`, `Gc`, `NativeMethod.cpp`, `.isHeap`, `ChunkParser.cpp`, `CallContext`, `ImageSave.cpp`, `Ast`, `Bootstrap`, `Parser`, `Compile.cpp`, `TEST`, `cstdint`, `.true_`, `applyChunks`, `ImageLoad.cpp`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `Heap` connect `Heap` to `WellKnown`, `.fromSmallInteger`, `LargeInteger.cpp`, `image_save_load_test.cpp`, `TEST`, `Oop`, `Float.cpp`, `Array.cpp`, `Heap.cpp`, `TEST`, `Globals.cpp`, `ao_main.cpp`, `Stream.cpp`, `intern`, `TEST`, `Boot`, `TEST`, `Session.cpp`, `Gc`, `NativeMethod.cpp`, `vector`, `.isHeap`, `CallContext`, `ImageSave.cpp`, `Bootstrap`, `CallContext`, `.nil`, `BlockContext.cpp`, `unwinding`, `String.cpp`, `putNative`, `DiskHeader`, `WellKnown.cpp`, `TEST`, `cstdint`, `TEST`, `TEST`, `Bootstrap.cpp`, `native_method_test.cpp`, `ImageLoad.cpp`, `GarbageFirstBoot`, `ObjectHeader`?**
