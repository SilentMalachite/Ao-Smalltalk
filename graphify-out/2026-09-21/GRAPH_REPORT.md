...
- Token cost: 38,041 input · 966 output
...
- Heap Module
- Oop Module
- P9-03 Errors and VoiceOver
- Collection Kernel Classes
- Swift Package Smoke
- Point and Rectangle Kernel
- Kernel Scan and Bench
- P0 Skeleton Phase
- P9-01 Do/Print/Inspect It
- NativeMethod Tests
- Behavior and Class Kernel
- P4 Kernel Native Plan
- Symbol Intern Tests
- Symbol and MethodDictionary
- Globals Implementation
- Native Installation
- Bootstrap Implementation
- Symbol Implementation
- P9-04 Golden Acceptance
- Oop Tag Tests
- Image and AppKit Tools
- P1-07 Immovable Objects
- Heap and WellKnown Headers
- Roots Visitor
...
### Community 10 - "Compiler and Interpreter Phases"
Cohesion: 0.07
...
### Community 11 - "GC Behavior Tests"
Cohesion: 0.07
...
### Community 12 - "GC Roots and Handles"
Cohesion: 0.12
...
### Community 15 - "Roots Implementation"
Cohesion: 0.24
...
### Community 17 - "Metaclass Cycle Tests"
Cohesion: 0.09
...
### Community 21 - "MethodDictionary Tests"
Cohesion: 0.32
...
### Community 31 - "Method Lookup Tests"
Cohesion: 0.21
...
### Community 35 - "Native Send Tests"
Cohesion: 0.18
...
### Community 44 - "P9-03 Errors and VoiceOver"
Cohesion: 0.25
...
### Community 49 - "P0 Skeleton Phase"
Cohesion: 0.22
...
### Community 53 - "P4 Kernel Native Plan"
Cohesion: 0.40
...
### Community 62 - "Image and AppKit Tools"
Cohesion: 0.33
...
### Community 63 - "P1-07 Immovable Objects"
Cohesion: 0.29
Nodes (6): Files, Interfaces, P1-07: immovable old objects, テスト, 手順, 目的

### Community 65 - "Roots Visitor"
Cohesion: 0.67
Nodes (3): walker_, Roots::visitAll(), VisitFn

## Knowledge Gaps
- **261 isolated node(s):** `AoPlaceholder`, `dropHandle`, `free_`, `handles_`, `live_` (+256 more)
...
- **Why does `Oop` connect `Oop Immediates and Mangling` to `P3 Native Dispatch`, `Core Runtime Headers`, `Smalltalk Global Dictionary`, `WellKnown Class Registry`, `Class Method Cache`, `GC Roots and Handles`, `Object Header Layout`, `Roots Implementation`, `GC Tests`, `Metaclass Cycle Tests`, `MethodDictionary Tests`, `WellKnown Implementation`, `Weak Slot GC`, `Method Lookup Tests`, `Native Send Tests`, `NativeMethod Tests`, `Symbol Intern Tests`, `Symbol and MethodDictionary`, `Globals Implementation`, `Native Installation`, `Bootstrap Implementation`, `Symbol Implementation`, `Heap and WellKnown Headers`?**
  _High betweenness centrality (0.222) - this node is a cross-community bridge._
- **Why does `Heap` connect `Heap Nursery Internals` to `P3 Native Dispatch`, `Core Runtime Headers`, `Smalltalk Global Dictionary`, `WellKnown Class Registry`, `Oop Immediates and Mangling`, `Object Header Layout`, `GC Tests`, `Metaclass Cycle Tests`, `Heap Allocation Tests`, `MethodDictionary Tests`, `WellKnown Implementation`, `Weak Slot GC`, `Method Lookup Tests`, `Native Send Tests`, `NativeMethod Tests`, `Symbol Intern Tests`, `Symbol and MethodDictionary`, `Globals Implementation`, `Native Installation`, `Bootstrap Implementation`, `Symbol Implementation`, `Heap and WellKnown Headers`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `WellKnown` connect `WellKnown Class Registry` to `Heap and WellKnown Headers`, `Core Runtime Headers`, `Heap Nursery Internals`, `Smalltalk Global Dictionary`, `WellKnown Implementation`, `Native Send Tests`, `Oop Immediates and Mangling`, `GC Roots and Handles`, `Metaclass Cycle Tests`, `NativeMethod Tests`, `MethodDictionary Tests`, `Symbol Intern Tests`, `Symbol and MethodDictionary`, `Globals Implementation`, `Native Installation`, `Bootstrap Implementation`, `Symbol Implementation`, `Method Lookup Tests`?**
...
- **What connects `AoPlaceholder`, `dropHandle`, `free_` to the rest of the system?**
