...
## Corpus Check
- 147 files · ~36,850 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 36 file(s) not represented in the graph (top: .st 25, (none) 10, .toml 1)

## Summary
- 1338 nodes · 3025 edges · 74 communities (62 shown, 12 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 252 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3baf2aa4`
...
Cohesion: 0.10
Nodes (60): Digits, __int128, int64_t, ao_ArrayedCollection_do_(), CallContext, uint32_t, add(), addBig() (+52 more)
...
### Community 12 - "Roots"
Cohesion: 0.09
Nodes (23): StackWalker, uint32_t, Roots, dropHandle, free_, handleAt, handles_, live_ (+15 more)
...
### Community 18 - "Boot"
Cohesion: 0.14
Nodes (13): makeSubclass(), formatOf(), floatValue(), makeFloat(), Boot, cache, ctx, heap (+5 more)
...
Cohesion: 0.13
Nodes (23): vector, ao_BlockContext_value(), ao_BlockContext_value_value_(), ao_BlockContext_valueWithArguments_(), applyBlock(), CallContext, NativeFn, string (+15 more)
...
### Community 40 - "P1-04 old-generation mark-compact"
Cohesion: 0.22
...
Cohesion: 0.18
Nodes (10): context, gc, globals, gtest, install, Root, slot, send (+2 more)
...
- **Why does `Oop` connect `Oop` to `WellKnown`, `P3 — Native Dispatch`, `.nil`, `LargeInteger.cpp`, `.isHeap`, `Heap.cpp`, `Behavior.cpp`, `TEST`, `SmallInteger.cpp`, `Roots`, `WellKnown.cpp`, `Boot`, `cstdint`, `TEST`, `String.cpp`, `putNative`, `ClassMethodCache`, `TEST`, `send`, `BlockContext.cpp`, `Roots.cpp`, `TEST`, `Bootstrap`, `P1-04 old-generation mark-compact`, `test_support.hpp`, `native_send_test.cpp`, `ClassDef`, `intern`, `create`, `Root`, `TEST`, `install`, `NativeMethod`?**
...
- **Why does `Heap` connect `Heap` to `WellKnown`, `P3 — Native Dispatch`, `.nil`, `LargeInteger.cpp`, `.isHeap`, `Heap.cpp`, `TEST`, `WellKnown.cpp`, `TEST`, `Boot`, `cstdint`, `TEST`, `String.cpp`, `putNative`, `Oop`, `ClassMethodCache`, `send`, `BlockContext.cpp`, `TEST`, `Bootstrap`, `test_support.hpp`, `native_send_test.cpp`, `intern`, `create`, `TEST`, `install`, `NativeMethod`?**
