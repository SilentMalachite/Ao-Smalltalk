...
## Corpus Check
- 106 files · ~17,404 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 11 file(s) not represented in the graph (top: (none) 10, .toml 1)

## Summary
- 632 nodes · 942 edges · 57 communities (38 shown, 19 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 83 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa32e634`
...
Cohesion: 0.08
Nodes (42): Phase P0 skeleton, Phase pipeline P0-P9, P0 phase doc, P1 — Object Memory, ao::Oop, ao::Gc, ao::Heap, nursery bump allocator (+34 more)
...
### Community 16 - "bootstrap_test.cpp"
Cohesion: 0.22
Nodes (9): Bootstrap, class skeleton, metaclass cycle, P2-03 metaclass cycle, Bootstrap, Globals, runtime/include/ao/Globals.hpp, P2-04 Smalltalk global dictionary (+1 more)

### Community 17 - "TEST"
Cohesion: 0.22
Nodes (9): ClassSkeletonsAreHeapAndNamed, ImmediateClassSlotsReserved, klass, size, slotAt, TEST(), SkeletonSlotsStartNil, WellKnownImmediatesMatchOopTags (+1 more)

### Community 18 - "P4-06 Stream / Transcript model"
Cohesion: 0.25
...
### Community 21 - "P4-07 Process / ProcessorScheduler / Semaphore"
Cohesion: 0.25
...
### Community 41 - "P4-05 Dictionary / Set / OrderedCollection"
Cohesion: 0.29
...
### Community 51 - "P4-09 Kernel NativeMethod scan and bench"
Cohesion: 0.29
...
### Community 53 - "Bootstrap.cpp"
Cohesion: 0.70
Nodes (4): allocateSkeletons(), allocClass(), run(), wireCycle()

### Community 54 - "P4 — Kernel Native Implementation"
Cohesion: 0.67
...
- **Why does `Oop` connect `Oop` to `WellKnown`, `cstdint`, `.nil`, `Heap.cpp`, `Roots`, `gc_test.cpp`, `int64_t`, `Bootstrap.cpp`, `gtest`, `Roots.cpp`, `Gc.cpp`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `Heap` connect `Heap` to `WellKnown`, `TEST`, `cstdint`, `Heap.cpp`, `gc_test.cpp`, `.nil`, `bootstrap_test.cpp`, `TEST`, `TEST`, `Bootstrap.cpp`, `gtest`, `Gc.cpp`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `P1-04 old-generation mark-compact` connect `docs/README.md` to `Gc.cpp`, `gc_test.cpp`?**
